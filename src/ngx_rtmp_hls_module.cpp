...
CHlsModule::CHlsModule()
{
	...
	codec_ctx.aac_sbr = 0;
	codec_ctx.aac_ps = 0;
	codec_ctx.avc_profile = 0;
	codec_ctx.avc_compat = 0;
	codec_ctx.avc_level = 0;
	codec_ctx.avc_nal_bytes = 0;
	codec_ctx.avc_ref_frames = 0;
	codec_ctx.sample_rate = 0;
	codec_ctx.sample_size = 0;
	codec_ctx.audio_channels = 0;
	...
	hacf.type = 0;
	hacf.slot = 0;
	hacf.max_audio_delay = 0;
	hacf.audio_buffer_size = 0;
	hacf.cleanup = 0;
	hacf.variant = 0;
	hacf.base_url = { 0 };
	hacf.granularity = 0;
