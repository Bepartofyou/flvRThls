/*
  ...
  gengetopt --input=/home/wupengqiang/work/av-part/test/flvRThls/src/cmdline.ggo --include-getopt --output-dir=/home/wupengqiang/work/av-part/test/flvRThls/src 
...
const char *gengetopt_args_info_purpose = "Flv To Hls for keyframe seek size.\n\nBy Bepartofyou <309554135@qq.com>";

const char *gengetopt_args_info_usage = "Usage: flvRThls [OPTIONS]...";
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'f':	/* the input flv file.  */
        
        
          if (update_arg( (void *)&(args_info->flvfile_arg), 
               &(args_info->flvfile_orig), &(args_info->flvfile_given),
        ...
        case 'g':	/* set segment time, unit: s .  */
          ...
          break;
        case 'o':	/* the output ts file path.  */
        ...
        case 'm':	/* generate m3u8 file Flag with default 'off'.  */
          ...
          if (update_arg((void *)&(args_info->m3u8_flag), 0, &(args_info->m3u8_given),
              &(local_args_info.m3u8_given), optarg, 0, 0, ARG_FLAG,
              check_ambiguity, override, 1, 0, "m3u8", 'm',
              additional_error))
            goto failure;
        
          break;
        case 't':	/* generate ts files Flag with default 'off'.  */
